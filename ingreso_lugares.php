                ...
                <form class="form3" action="app/guardarLugares.php" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="row">
                      <div class="col-md-12 content_cajas">
                          ...
                          <input class="form_input" type="text" id="lugares" name="lugares" onkeypress="return sololetras(event)" required placeholder="Escriba lugares">
                      </div>
...
<script>
        ...
        <script>
            $(document).on('keyup','#lugares', function(){
            ...
            <div class="cont_tabla">
              <table class="tabla">
                ...
                <tr>
                  <?php
                    $consulta=mysqli_query($con,"SELECT * from lugares ");
