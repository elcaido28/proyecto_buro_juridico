        ...
        <div class="camino">
            ...
            <div class="cont_tabla">
              <table class="tabla">
                ...
                <tr>
                  <?php
                    $consulta=mysqli_query($con,"SELECT * from clientes C inner join tipo_cliente TC on TC.id_tipo_cliente=C.id_tipo_cliente where C.id_estado='1' ");
                  ...
                  <td>
                    <div class="cont_tbn_tb">
                      ...
                      <button type="button" class="btn btn-danger eliminar" title="Eliminar" id="<?php echo $row['id_clientes'] ?>" name="button" id="elim">
