                ...
                <form class="form3" action="app/guardarGenero.php" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="row">
                      <div class="col-md-12 content_cajas">
                          ...
                          <input class="form_input" type="text" id="genero" name="genero" required onkeypress="return sololetras(event)" placeholder="Escriba Genero">
                      </div>
...
<script>
        ...
        <script>
            $(document).on('keyup','#genero', function(){
            var valr= $('#genero').val();
            if(valr!=""){
            ...
            <div class="cont_tabla">
              <table class="tabla">
                ...
                <tr>
                  <?php
                    $consulta=mysqli_query($con,"SELECT * from genero ");
