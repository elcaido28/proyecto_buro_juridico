                ...
                <form class="form3" action="app/guardarTipoEmpleado.php" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="row">
                      <div class="col-md-12 content_cajas">
                          ...
                          <input class="form_input" type="text" id="tipo_emple" name="tipo_emple" id="tipo_emple" onkeypress="return sololetras(event)" required placeholder="Escriba Tipo De Empleado">
                      </div>
...
<script>
                ...
                <script>
    $(document).on('keyup','#tipo_emple', function(){
            ...
            <div class="cont_tabla">
              <table class="tabla">
                ...
                <tr>
                  ...
                  <td>  <?php if($row['id_tipo_empleado']!='13' && $row['id_tipo_empleado']!='1' && $row['id_tipo_empleado']!='3'){ ?>
